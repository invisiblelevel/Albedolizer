...
T = {
    "ru": {
        ...
        "welcome_1": "👋 Добро пожаловать в Albedolizer v1.3.2-beta",
    ...
    "en": {
        ...
        "welcome_1": "👋 Welcome to Albedolizer v1.3.2-beta",
...
def main(page: ft.Page):
    ...
    page.title = "Albedolizer v1.3.2-beta"
    ...
    def pil_to_b64(data, max_size=900):
        # Принимает PIL Image или numpy array float32
    ...
    def toggle_tiling(e):
        ...
        # Обновляем превью — если есть загруженная текстура
        img = None
        ...
        about_content = ft.Container(
            content=ft.Column([
                ...
                ft.Row([ft.Text(f"{t('about_version')}:", color=FG3, size=12,
                        ...
                        ft.Text("1.3.2-beta", color=FG, size=12,
                ...
                ft.Column([
                    ft.Row([
                        ft.Text("◐ Albedolizer", size=20,
                                ...
                                color=ACCENT, font_family=FONT),
                        ft.Container(
                            content=ft.Text("v1.3.2-beta", size=10, color=FG2,
                                            font_family=FONT,
                                            weight=ft.FontWeight.W_600),
                            bgcolor=CARD, border_radius=6,
