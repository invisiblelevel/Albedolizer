...
from image_processor import fallback_correct, ai_correct
        ...
        about_content = ft.Container(
            content=ft.Column([
                ...
                ft.Row([ft.Text(f"{t('about_version')}:", color=FG3, size=12,
                        ...
                        ft.Text("1.4.0-beta", color=FG, size=12,
                ...
                ft.Column([
                    ft.Row([
                        ft.Text("◐ Albedolizer", size=20,
                                ...
                                color=ACCENT, font_family=FONT),
                        ft.Container(
                            content=ft.Text("v1.4.0-beta", size=10, color=FG2,
                                            font_family=FONT,
                                            weight=ft.FontWeight.W_600),
                            bgcolor=CARD, border_radius=6,
